...
public class Automovil implements Comparable<Automovil> {
    ...
    private Motor motor;
    private TanqueGasolina estanque;
    ...
    public Automovil(String fabricante, String modelo, Color color, Motor motor, TanqueGasolina tanque){
        this(fabricante,modelo,color,motor);
        this.estanque = tanque;
    }

    public Automovil(String fabricante, String modelo, Color color, Motor motor, TanqueGasolina tanque, Persona conductor, Rueda[] rueda){
    ...
    public TanqueGasolina getEstanque() {
        if(estanque == null){
            this.estanque = new TanqueGasolina();
        }
        return estanque;
    }

    public void setEstanque(TanqueGasolina estanque) {
    ...
    public Automovil addRueda(Rueda rueda){
        ...
        return this; //Se retorna el objeto automovil y permite el encadenamiento del metodo
    }
